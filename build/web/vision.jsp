                ...
                <div id="container">
                    ...
                    <div id="main">
                        <div style="border-radius: 20px;height: 600px;padding-top: 20px; width: 80%; background-color: bisque;margin: 0 auto;margin-top: 100px;box-shadow: 3px 3px 5px;">
                            <h1 style="color: red; text-align: center;font-size: 50px;">Vision</h1>
                            <div style="width: 90%;font-size: 18px; color: blue;margin: 0 auto;height: 400px;">The institute offers <i>DM/MCh/PDF/PDCC/and Senior Residency (Hospital Services)</i> training programs in
